...
<head>
    ...
    <style>
         /* Floating Card (Default for Desktop) */
         .floating-card {
            position: fixed;
            top: 150px;
            left: 20px;
        ...
        /* Toggle Button (Vertically Centered on the Left) */
        .toggle-panel-btn {
            position: fixed;
            top: 50%;
            left: 10px;
...
<button class="toggle-panel-btn">Overview</button>
...
<!--for responsiveness of the floating-card-->
<script>
    document.addEventListener('DOMContentLoaded', function () {
    var floatingCard = document.querySelector('.floating-card');
    var toggleButton = document.querySelector('.toggle-panel-btn');
    var closeButton = document.querySelector('.close-panel');
